<template>
  <div class="modal d-flex align-items-center bg-secondary" style="display: block; --bs-bg-opacity: .3;" tabindex="-1" aria-hidden="false" aria-labelledby="modal-title">
    <div class="modal-dialog" role="document">
      <div class="modal-content" style="width: 400px;">
        ...
        <div class="modal-footer d-flex justify-content-center">
          <button type="button" class="btn text-white" style="background-color: #056b80;" @click="submit">Submit</button>
        </div>
      </div>
    </div>
  </div >
...
const submit = async () => {
  ...
  if(signInRes.status < 300 && signInRes.status >= 200) {
    ...
    store.saveUsername(login.value);
